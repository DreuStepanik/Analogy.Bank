...
function findNeedle(haystack) {
  // Declare a variable to store the value of finding the needle.
  // use the .indexOf() method to search for the specific key word to be found.
  var foundTheNeedle = "found the needle at position " + haystack.indexOf("needle");
